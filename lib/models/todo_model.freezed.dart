...
mixin _$Todo {
  ...
  String get description =>
      throw _privateConstructorUsedError; // using the @Default() annotation to provide a default false value to
...
abstract class _Todo implements Todo {
  ...
  @override
  String get description;
  @override // using the @Default() annotation to provide a default false value to
// the `isCompleted` property
